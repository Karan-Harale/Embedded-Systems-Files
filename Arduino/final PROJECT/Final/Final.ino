...
pinMode(in1,OUTPUT);         // Rain Sensor:
pinMode(in2,OUTPUT);
...
{
pinMode(sm, INPUT);
pinMode(motor, OUTPUT);        // Soil moisture Sensor
...
Serial.println();
Serial.println("1.Humidity & Temperature Sensor");
...
{
Serial.println();
Serial.println("2.Rain Condition");
...

{
  ...
  {
  Serial.println();  
  Serial.println("3.Artificial Light Condition");
...
{
 Serial.println();
Serial.println("4.Soil Moisture");
